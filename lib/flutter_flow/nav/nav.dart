...
class AppStateNotifier extends ChangeNotifier {
  LpbpFirebaseUser? initialUser;
  LpbpFirebaseUser? user;
  ...
  void update(LpbpFirebaseUser newUser) {
    initialUser ??= newUser;
    user = newUser;
        ...
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              name: 'marcacao',
              path: 'marcacao',
              builder: (context, params) => MarcacaoWidget(),
            ),
            FFRoute(
              name: 'login',
              path: 'login',
            ...
            FFRoute(
              ...
              builder: (context, params) => ListafuncionarioWidget(),
            ),
            FFRoute(
              name: 'presenca',
              path: 'presenca',
